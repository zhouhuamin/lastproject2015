...
public:
	...
	int PackUploadData0X32(CppMySQL3DB* pDatabase, char* szPlatName, char* pData, int nLen, char* szPackedData, int& nPacketDataLen,int nIsRegather=0);
...
private:
	...
	int ProcessPacket0X31(CppMySQL3DB* pDatabase, char* pData, int nLen);
