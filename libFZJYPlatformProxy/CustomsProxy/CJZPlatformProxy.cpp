...
strControlData	= \
"<LEVER>\r\n"
"  <LEVER_CODE>00</LEVER_CODE>\r\n"
"  <LEVER_MSG>直接放行</LEVER_MSG>\r\n"
"</LEVER>\r\n"
"<LED>\r\n"
...
"</PRINT>\r\n";        
        ...
        sprintf(m_szResultCtrlXML, "%s <EVENT type=\"CAR_FREE\" hint=\"车辆放行\" eventid=\"%s\"><![CDATA[%s]]></EVENT>", m_szResultCtrlXML, "S000000001", strControlData.c_str());
