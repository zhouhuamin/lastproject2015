...
${OBJECTDIR}/common.o: common.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common.o common.c

${OBJECTDIR}/config.o: config.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config.o config.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/moxa_setting.o: moxa_setting.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/moxa_setting.o moxa_setting.c

${OBJECTDIR}/msg.o: msg.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msg.o msg.c

${OBJECTDIR}/net_handle.o: net_handle.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/net_handle.o net_handle.c

${OBJECTDIR}/reader1000api.o: reader1000api.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/reader1000api.o reader1000api.c
