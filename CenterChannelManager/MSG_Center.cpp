...
int CMSG_Center::handleExceptionFree(NET_PACKET_MSG* pMsg)
{
	...
	m_pPlatformProxy->BuildExceptionFreeData(pDatabase, pCtrlCmdData->szChnnl_No, pCtrlCmdData->szSequence_No, pCtrlCmdData->szExceptionFreeData, pCtrlCmdData->szMEM);
