...
${OBJECTDIR}/common.o: common.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -Ilib/libxml -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common.o common.c

${OBJECTDIR}/config.o: config.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -Ilib/libxml -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config.o config.c

${OBJECTDIR}/ic_card.o: ic_card.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -Ilib/libxml -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ic_card.o ic_card.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -Ilib/libxml -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/msg.o: msg.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -Ilib/libxml -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/msg.o msg.c

${OBJECTDIR}/net_handle.o: net_handle.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilib -Ilib/libxml -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/net_handle.o net_handle.c
