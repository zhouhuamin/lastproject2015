...
public:
	...
	int handleControlResultAck(NET_PACKET_MSG* pPacket);
    int handleCustomsDataAck(NET_PACKET_MSG* pPacket);
	int handleManFangXi(NET_PACKET_MSG* pPacket);
	...
	int QueryMonitorRecord(T_MonitorStationRel &monitorInfo);
