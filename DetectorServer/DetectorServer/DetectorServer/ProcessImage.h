...
private:
	...
	pthread_t statusTableThreadIDV2;
	pthread_t statusTableThreadIDV3;

private:
	static void *ProcessControllerThread(void *pParam);
	static void *ProcessStatusTableThread(void *pParam);
	static void *ProcessDetectorThread(void *pParam);
	static void *ProcessStatusTableThreadV2(void *pParam);
	static void *ProcessStatusTableThreadV3(void *pParam);

	void ProcessControllerProc();
	void ProcessStatusTableProc();
	void ProcessDetectorProc();
	void ProcessStatusTableProcV2();
	void ProcessStatusTableProcV3();
