...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/channelcontrolserver

/root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/channelcontrolserver: ../../tools/ACE_wrappers/lib/libACE.so

/root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/channelcontrolserver: ${OBJECTFILES}
	${MKDIR} -p /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/channelcontrolserver ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CmdHandler_T.o: CmdHandler_T.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CmdHandler_T.o CmdHandler_T.cpp

${OBJECTDIR}/Cmd_Acceptor.o: Cmd_Acceptor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cmd_Acceptor.o Cmd_Acceptor.cpp

${OBJECTDIR}/ControlCmdHandler.o: ControlCmdHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ControlCmdHandler.o ControlCmdHandler.cpp

${OBJECTDIR}/Log/FreeLongLog.o: Log/FreeLongLog.cpp 
	${MKDIR} -p ${OBJECTDIR}/Log
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Log/FreeLongLog.o Log/FreeLongLog.cpp

${OBJECTDIR}/MSG_Center.o: MSG_Center.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MSG_Center.o MSG_Center.cpp

${OBJECTDIR}/MutexGuard.o: MutexGuard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MutexGuard.o MutexGuard.cpp

${OBJECTDIR}/MyLog.o: MyLog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyLog.o MyLog.cpp

${OBJECTDIR}/SimpleConfig.o: SimpleConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimpleConfig.o SimpleConfig.cpp
...
${OBJECTDIR}/tinyXML/xml_config.o: tinyXML/xml_config.cpp 
	${MKDIR} -p ${OBJECTDIR}/tinyXML
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../tools/ACE_wrappers -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tinyXML/xml_config.o tinyXML/xml_config.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/channelcontrolserver
