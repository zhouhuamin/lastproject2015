...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/recoservermanager

/root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/recoservermanager: ../../tools/ACE_wrappers/lib/libACE.so

/root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/recoservermanager: ${OBJECTFILES}
	${MKDIR} -p /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/recoservermanager ${OBJECTFILES} ${LDLIBSOPTIONS}
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} /root/jiezisoft/bin/${CND_CONF}/${CND_PLATFORM}/recoservermanager
