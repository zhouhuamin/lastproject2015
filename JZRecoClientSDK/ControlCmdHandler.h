...
public:
	int ProcessContaIDCheckBit(JZ_ContaIDCheckBitRequest *pRequest,		JZ_ContaIDCheckBitResponse *pResponse);
	int ProcessContaIDCorrected(JZ_ContaIDCorrectionRequest *pRequest,	JZ_ContaIDCorrectionResponse *pResponse);
	int ProcessContaIDCount(JZ_ContaIDCountRequest *pRequest,			JZ_ContaCountResponse *pResponse);
