...
char CSimpleConfig::BACK_SERVER_IP[32];
int CSimpleConfig::BACK_SERVER_PORT;
...
void CSimpleConfig::get_config()
{
    ...
    sprintf(cpPath, "%sFrontServerConfig.xml", strFullExeName.c_str());
	...
	strcpy(BACK_SERVER_IP, xmlConfig.GetValue("BACK_SERVER_IP").c_str());

	event_port = xmlConfig.GetValue("BACK_SERVER_PORT").c_str();
	BACK_SERVER_PORT = atoi(event_port.c_str());
