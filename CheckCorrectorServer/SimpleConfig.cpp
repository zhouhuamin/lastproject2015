...
int CSimpleConfig::CORRECTOR_LISTEN_PORT;
...
void CSimpleConfig::get_config()
{
    ...
    sprintf(cpPath, "%sCheckCorrectorConfig.xml", strFullExeName.c_str());
    ...
    string listen_port = xmlConfig.GetValue("CHECK_CORRECTOR_LISTEN_PORT");
    CORRECTOR_LISTEN_PORT = atoi(listen_port.c_str());
